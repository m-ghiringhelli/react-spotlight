...
export const printAddress = ({name, address: {street: streetName, number: streetNumber, city: streetCity, country: streetCountry}}) => {
  return `${name} lives at ${streetNumber} ${streetName}, ${streetCity}, ${streetCountry}`;
}
